...
//   console.log(`website: ${e.website} and email: ${e.email}`);
// });
...
// const num9 = user.filter(function(e) {
//   return e.userId === 9;
// });
// // console.log(num9);

// const imcomplete = num9.filter(function(e) {
...
const user5 = posts.filter(function(e) {
  return e.userId === 5;
});

console.log(user5);

const pair = user5.map(function(e) {
